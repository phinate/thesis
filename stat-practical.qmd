...
We can then say that, under the assumption of $H_0$ (i.e. $x\sim p(x|\mu_0)$), $-2\ln \lambda(x,\mu_0)$ follows a $\chi^2$ distribution with one degree of freedom. This is known as **Wilks' theorem** @wilks.
