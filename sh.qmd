...
![A grid of the different points for which data originating from the signal process was simulated.](images/sh/mass-grid.pdf){#fig-mass-grid}
...
For either strategy in @sec-fit-strategies, we're interested in some kind of way to make inference about points in-between those we've already simulated in @fig-mass-grid
