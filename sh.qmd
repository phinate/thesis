...
- Interactions involving the strong force (known as QCD -- quantum chromodynamics) that result in two photons and two jets (shorthand of $\gamma\gamma jj$)
...
| QCD              | SHERPA2 (ME@NLO+PS) |              |                   | $\gamma\gamma$+0,1(NLO),2,3(LO), $m_{\gamma\gamma} \in 90-175\, \text{GeV}$ |
| QCD              | MGMCatNLO + PYTHIA8 |              |                   | $t\bar{t}\gamma\gamma$ (noallhad)                      |
| QCD              | MGMCatNLO + PYTHIA8 |              |                   | $t\bar{t}\gamma\gamma$ (allhad)                        |
