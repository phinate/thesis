...
A flexible class of models that come with a notion of uncertainty are **Gaussian processes**. They model a set of data points as normally distributed random variables, and use this
