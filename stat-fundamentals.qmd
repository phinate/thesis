...
From here, we can examime the pdf (at $\mu=10$ arbitrarily) and the likelihood (at $x=10$ arbitrarily):

```{python}
#| label: fig-density
#| fig-cap: "Plots of the probability density function for $\\mu$ = 10"
import jax
