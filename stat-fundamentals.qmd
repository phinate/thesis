...
Depending on whose axioms you follow, this quantity may be either derived (as in [@kolmogorov-thing]) or axiomatically stated (as in [@definetti]).
...
We can also define  the **cumulative density function**, defined for random variable $X$ as $P(X \leq x)$. We can then write this in terms of the probability density function:
