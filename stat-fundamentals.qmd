...
Ah yes, the infamous histogram. Exceedingly simple by design, it approximates a data distribution through counting the number of data points that lie in a set of adjacent disjoint intervals, or **bins**. A histogram, then, is expressable as a set of counts and a set of bin edges. See some example histograms in
...
<!-- ![Visualization of a hypothesis test](visualtest){#fig-visualtest} -->
