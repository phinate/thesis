...
The parameters $\mu$ and $\sigma$ characterize the location and the width of the normal distribution respectively. In shorthand, we'll denote this as $\mathrm{Normal}(\mu, \sigma)$.
