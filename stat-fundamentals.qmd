...
We can visualize the probability density for each of $\mu_{\mathrm{lower}}$ and $\mu_{\mathrm{upper}}$, which should help cement the idea of capturing some amount of the probability based on an ordering of $x$:
