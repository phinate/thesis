...
![The "ball-and-stick" representation of a MLP.](mlp){#fig-ballandstick}
...
Since a neural network is a sequence of applications of @eq-layer, it's differentiable with respect to the parameters
